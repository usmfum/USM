...
contract OurUniswapV2SpotOracle is Oracle {
    ...
    bool public tokensInReverseOrder;
    uint public scaleFactor;
     ...
     */
    constructor(address pair_, bool tokensInReverseOrder_, uint scaleFactor_) public {
    ...
    function latestPrice() public virtual override view returns (uint price) {
        ...
        (uint112 reserveA, uint112 reserveB) = tokensInReverseOrder ? (reserve1, reserve0) : (reserve0, reserve1);
