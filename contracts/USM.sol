...
contract USM is IUSM, ERC20Permit, Delegable {
    ...
    uint public constant NUM_ORACLES_TO_MEDIAN = 3;
    ...
    constructor(address eth_, address chainlinkOracle_, address compoundOracle_,
                ...
                address uniswapDaiEthPair_, bool uniswapDaiEthPairInReverseOrder_) public ERC20Permit("Minimal USD", "USM")
    {
    ...
    function ethToUsm(uint ethAmount) public view returns (uint usmOut) {
        usmOut = oraclePrice().wadMul(ethAmount);
    }
    ...
    function usmToEth(uint usmAmount) public view returns (uint ethOut) {
        ethOut = usmAmount.wadDiv(oraclePrice());
    }
